...
@Component({
  selector: 'app-busqueda-agrupado',
  templateUrl: './busqueda-agrupado.component.html',
  styleUrl: './busqueda-agrupado.component.css'
})
export class BusquedaAgrupadoComponent {
